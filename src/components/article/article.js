...
function articleMaker(articleObj) {
  ...
  article.appendChild(articlePp);
  article.appendChild(articlePpp);
  article.appendChild(expandButton);

  articleTitle.textContent = articleObj.title;
  articleDate.textContent = articleObj.date;
  articleP.textContent = articleObj.firstParagraph;
  articlePp.textContent = articleObj.secondParagraph;
  articlePpp.textContent = articleObj.thirdParagraph;
